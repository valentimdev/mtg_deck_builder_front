...
export default function DeckBuilderPage() {
    ...
    const handleSearchStart = (query: string) => {
        ...
        // Clear previous results while loading new ones to avoid confusion or show stale data?
        // Maybe keep them but show loading overlay.
    ...
    return (
        <CardDialogProvider
            ...
            onUpdateCard={deckState.updateCard}
        >
